...
const AboutMe = () =>{
    return(
        <div className='AboutMe '>
            ...
            <p className='about-lorem'> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
                ...
                sem quam semper libero, sit amet adipiscing sem neque</p>
        </div>
    )
}
